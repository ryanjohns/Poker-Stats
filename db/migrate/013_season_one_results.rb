class SeasonOneResults < ActiveRecord::Migration
  ...
  def self.up
    ...
    Result.create!(:tournament=>t, :player=>@shannon_watters, :place=>14, :bounty_collector=>@steve_radulovich, :fee_paid=>false)
    ...
    Result.create!(:tournament=>t, :player=>@randy_watters, :place=>6, :bounty_collector=>@shawn_green, :fee_paid=>false)
    ...
    Result.create!(:tournament=>t, :player=>@tim_resnik, :place=>4, :bounty_collector=>@kristy_arnett, :fee_paid=>true)
