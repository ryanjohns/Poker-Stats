class FourthTourneyResults < ActiveRecord::Migration
  ...
  def self.up
    ...
    Result.create!(:tournament=>t, :player=>shawn_green, :place=>15, :bounty_collector=>zack_messer, :fee_paid=>true)
    ...
    Result.create!(:tournament=>t, :player=>ronnie_morone, :place=>14, :bounty_collector=>kristy_arnett, :fee_paid=>true)
    ...
    Result.create!(:tournament=>t, :player=>scott_dedoes, :place=>13, :bounty_collector=>brian_fidler, :fee_paid=>true)
    ...
    Result.create!(:tournament=>t, :player=>ryan_johns, :place=>12, :bounty_collector=>lizzy_morone, :fee_paid=>true)
    ...
    Result.create!(:tournament=>t, :player=>bethany_cermak, :place=>11, :bounty_collector=>mark_schmitz, :fee_paid=>true)
    
    laura_rody = Player.find_or_create_by_first_name_and_last_name("Laura", "Rody")
    Result.create!(:tournament=>t, :player=>laura_rody, :place=>10, :bounty_collector=>lizzy_morone, :fee_paid=>true)
    
    erik_fast = Player.find_or_create_by_first_name_and_last_name("Erik", "Fast")
    Result.create!(:tournament=>t, :player=>erik_fast, :place=>9, :bounty_collector=>brian_fidler, :fee_paid=>true)
    ...
    Result.create!(:tournament=>t, :player=>eric_tipton, :place=>7, :bounty_collector=>alex_farley, :fee_paid=>true)
    
    Result.create!(:tournament=>t, :player=>zack_messer, :place=>6, :bounty_collector=>brian_fidler, :fee_paid=>true)
    Result.create!(:tournament=>t, :player=>kristy_arnett, :place=>5, :bounty_collector=>brian_fidler, :fee_paid=>true)
    Result.create!(:tournament=>t, :player=>lizzy_morone, :place=>4, :bounty_collector=>brian_fidler, :fee_paid=>true)
    Result.create!(:tournament=>t, :player=>alex_farley, :place=>3, :bounty_collector=>brian_fidler, :fee_paid=>true)
